...
This page documents `src/io/mod.rs` (the module hub for the `io` package), `src/io/stl.rs` (ASCII/binary STL mesh reading and writing), and `src/io/volume.rs` (TIFF and RAW volume reading and writing).
